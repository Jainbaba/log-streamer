...
from .serializers import LevelSerializer, HostSerializer, RequestMethodSerializer,LogSerializer
    ...
    def get(self, request):
        try:
            ...
            if cached_data:
                ...
                request_methods = RequestMethodSerializer(RequestMethod.objects.all(), many=True).data
                data = {
                    "levels": levels,
                    "hosts": hosts,
